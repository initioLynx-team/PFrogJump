...
{
    public enum FrogState { Idle, Moving, Throw, Throwing, PickUp, OnAir, Charging, Jump, Jumping }
    ...
    void Think()
    {
        ...
        if (currentState == FrogState.Moving)
        {
